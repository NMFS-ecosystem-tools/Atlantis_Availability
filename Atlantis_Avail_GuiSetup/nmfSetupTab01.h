 ...
 * in this tab. Its only purpose is to give the user an introduction to the Setup tabs.
 */
...
public:
    /**
     * @brief nmfSetup_Tab1 : This GUI displays some Getting Started text to guide the user
     * through the rest of the Setup process
     * @param setupTab : The tab widget into which the Setup Help tab will be placed
     */
